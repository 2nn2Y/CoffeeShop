...
namespace YT.Migrations.Seed
{
    public class DefaultTenantBuilder
    {
        ...
        private void CreateDefaultCharge()
        {
            ...
            {
                new ChargeType("50元", "冲50得55咖啡券",5000,5500),
                new ChargeType("100元", "冲100得120咖啡券",10000,12000),
                new ChargeType("200元", "冲200得260咖啡券",20000,26000),
                new ChargeType("300元", "冲300得400咖啡券",30000,40000),
                new ChargeType("500元", "冲500得700咖啡券",50000,70000),
